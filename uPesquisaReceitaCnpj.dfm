object formPesquisaReceitaCnpj: TformPesquisaReceitaCnpj
  Left = 288
  Top = 298
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Pesquisa CNPJ Receita Federal'
  ClientHeight = 169
  ClientWidth = 645
  Color = clBtnFace
  ...
  object ACBrConsultaCNPJ1: TACBrConsultaCNPJ
    ProxyPort = '8080'
    PesquisarIBGE = False
    IniServicos = 'C:\Engegraph\Borland\Delphi7\Bin\ACBrConsultaCNPJServicos.ini'
    Left = 568
    Top = 8
  end
end
